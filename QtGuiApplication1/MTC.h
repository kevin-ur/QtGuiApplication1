...
#define MTCBuild 1
#define MTCRevision 2
#define MTCVERSION_STR "3, 8, 1, 2"
...
EXT mtCompletionCode CCONV Facet_SetTemplateVectorsFromSamplesAndGetXf(mtHandle handle, mtHandle SampledVectorPairsCollection, double MaxSampleErrorAllowedMM, mtHandle outSampleToFacetXformHandle);
...
EXT mtCompletionCode CCONV Camera_UpdateCalibrationFile(mtHandle handle,
														...
														double STD, double Gap, char *Date, bool IsVerified, bool IsOutsideSpecification, bool Reset);
